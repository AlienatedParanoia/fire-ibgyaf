...
/**
 * ShaderBackground — renders ONLY the animated WebGL shader on a <canvas>.
 * Drop it behind any content as an absolutely-positioned background layer.
 */
export const ShaderBackground: React.FC<{ className?: string }> = ({ className = "" }) => {
  ...
  return (
    <canvas
      ref={canvasRef}
      aria-hidden="true"
      className={`h-full w-full touch-none object-cover ${className}`}
